    ...
    <div class="wrapper">
        ...
        <div class="card">
            ...
            <div class="hero">
                ...
                <div class="hero-title">Let's Build Something<br /><span>Amazing</span></div>
                <div class="hero-sub">A new contact form submission has arrived and is ready for your review.</div>
            </div>
            ...
            <!-- Footer -->
            {{-- <div class="footer">
                <div class="footer-text">Sent via <strong>Contact Form</strong> on your website</div>
                <div class="footer-dot"></div>
                <div class="footer-text">Reply directly to the sender's email above</div>
            </div> --}}
